...
const discrepancyAttackRangeRfc = useSimpleDescription('about-discrepancy-2', `%i:${STAT_ICON.attackRange}%attack range with [${simpleFormattingGameAbilityImage('item', ITEM_NAME_TO_ID.rfc)}Rapid Firecannon's](https://wiki.leagueoflegends.com/en-us/Rapid_Firecannon) passive active has a <span class="error-margin">margin of error of <strong>1</strong></span>. I don't know why ([config with chogath with R 6 stacks/rakan from test](#TODO))`);
